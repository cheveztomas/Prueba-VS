    ...
    <div class="DivSesion">
        ...
        <form class="px-4 py-3">
            <div class="form-group">
                ...
                <asp:TextBox ID="txt_Correo" runat="server" class="form-control" placeholder="email@example.com" TextMode="Email" ValidationGroup="Registrar"></asp:TextBox>
            </div>
            <div class="form-group">
                <label for="exampleDropdownFormPassword1">Contraseña</label>
                <asp:TextBox class="form-control" id="txt_Conrteasenia" placeholder="Password" runat="server" TextMode="Password" ValidationGroup="Registrar"></asp:TextBox>
            </div>
            <div class="form-group">
                <label for="exampleDropdownFormPassword1">Confirmar Contraseña</label>
                <asp:TextBox class="form-control" id="txt_ConrteaseniaConfir" placeholder="Password" runat="server" TextMode="Password" onblur="ValidarPassword()" ValidationGroup="Registrar"></asp:TextBox>
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="txt_Nombre" runat="server" class="form-control" ValidationGroup="Registrar"></asp:TextBox>
            </div>
            <div class="form-group">
                <label for="exampleDropdownFormEmail1">Primer Apellido</label>
                <asp:TextBox ID="Txt_Apellido1" runat="server" class="form-control" ValidationGroup="Registrar"></asp:TextBox>
            </div>
            <div class="form-group">
                <label for="exampleDropdownFormEmail1">Segundo Apellido</label>
                <asp:TextBox ID="Txt_Apellido2" runat="server" class="form-control" ValidationGroup="Registrar"></asp:TextBox>
            </div>
            <div class="form-group">
                <label for="exampleDropdownFormEmail1" id="df">Teléfono</label>
                <asp:TextBox ID="Txt_Telefono" runat="server" class="form-control" ValidationGroup="Registrar"></asp:TextBox>
            </div>
            <div class="form-group">
                <label for="exampleDropdownFormEmail1">Descripción</label>
                <asp:TextBox ID="Txt_Descipcion" runat="server" class="form-control" TextMode="MultiLine" ValidationGroup="Registrar"></asp:TextBox>
            </div>
